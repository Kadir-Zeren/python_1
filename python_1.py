...
print("""This is the example docstrings.
'Comments or docstrings' are not printed on the
screen.""")
...
print('kullanici ismi') # Burada kullanici ismi yazdiriliyor.
